...
namespace QuantConnect.ToolBox.BinanceUsDownloader
{
    /// <summary>
    /// Kraken Data Downloader class
    /// </summary>
    public class BinanceUsDataDownloader : IDataDownloader
    {
        private const string UrlPrototype = @"https://api.binance.us/api/v3/klines?symbol={0}&interval=1m&startTime={1}&limit=1000";
        ...
        public IEnumerable<BaseData> Get(DataDownloaderGetParameters dataDownloaderGetParameters)
        {
            ...
            {
                throw new NotSupportedException("Only Minute Resolution is supported.");
            }

            var startUnixTime = new DateTimeOffset(startUtc).ToUnixTimeMilliseconds();
            var endUnixTime = new DateTimeOffset(endUtc).ToUnixTimeMilliseconds();
