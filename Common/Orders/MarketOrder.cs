...
namespace QuantConnect.Orders
{
    ...
    public class MarketOrder : Order
    {
        ...
        /// <param name="tag">User defined data tag for this order</param>
        /// <param name="properties">The order properties for this order</param>
        /// <param name="userProperties">The user set order properties for this order</param>
        public MarketOrder(Symbol symbol, decimal quantity, DateTime time, string tag = "", IOrderProperties properties = null, OrderUserProperties userProperties = null)
